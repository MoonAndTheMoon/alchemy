...
var eventName = "🐰️ Easter 🐣"
var eventBackgroundColor = "lightblue"
var eventFontColor = "black"
var eventBorderColor = "white"
var eventElements = ["2026","chick","goose","carrot","easter","fawkes","meadow","spring","tulips","dreamer","flowers","katrina","ladybug","butterfly","candy bar","sweetener","storybook","tangerine","baby bunny","easter egg","pastel egg","robin song","basil sprig","chick plush","daisy field","easter lily","easter card","flower seed","garden path","meadow walk","pastel pink","rain shower","spring rain","tulip field","egg painting","garden bloom","garden tulip","garden party","meadow scene","pastel shade","pastel color","resurrection","spring aroma","blooming tree","chocolate egg","easter dinner","easter candle","easter parade","easter sermon","easter prayer","flower basket","flower wreath","festive decor","lenten prayer","lamb figurine","lenten season","renewal cycle","spring growth","spring flower","spring season","spring garden","spring breeze","spring picnic","blossom branch","blooming shrub","butterfly wing","bunny painting","easter sunrise","egg decoration","egg decorating","fresh greenery","garden revelry","holiday sermon","holiday brunch","joyful reunion","renewal symbol","spring holiday","spring blossom","blooming flower","blooming cherry","burgeoning leaf","butterfly wings","chick hatchling","daffodil yellow","easter egg hunt","lilac fragrance","marzipan figure","spring wardrobe","spring cleaning","spring twilight","spring vacation","spring sunshine","spring rainfall","sunshine warmth","easter tradition","joyful gathering","pollen explosion","spring awakening","sunshine glitter","springtime event","brilliant sunrise","easter decoration","easter celebration","flower arrangement","holiday celebration","rejuvenation energy"]
