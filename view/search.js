...
function findChains() {
  ...
  console.log( "Median distance:", [...fullpathResults].sort( (a, b) => b[1] - a[1] )[Math.floor(fullpathResults.size / 2)] )
}
